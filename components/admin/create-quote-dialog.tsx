    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden flex flex-col p-0">
        <DialogHeader className="px-6 pt-6 pb-4">
          <DialogTitle className="text-2xl font-display">Nueva Cotización</DialogTitle>
          <DialogDescription>Complete los detalles para crear una nueva cotización de roofing</DialogDescription>
        </DialogHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="proyecto" placeholder="Ej: Reemplazo de techo residencial" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="direccion">Dirección *</Label>
                    <Textarea id="direccion" placeholder="Dirección completa del proyecto" rows={2} />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="area" type="number" placeholder="250" />
                  </div>
        ...
        <DialogFooter className="px-6 py-4 border-t bg-muted/30 flex-shrink-0">
          ...
          <Button onClick={handleCreateAndSend} className="bg-blue-600 hover:bg-blue-700">
